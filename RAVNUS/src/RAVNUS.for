...
12002 WRITE(*, '(A)') 'ббедхре оюпюлерпш йнпосяю х бндш бнднелю'
12004 WRITE(*,2004)
2004  FORMAT(/1X,'ьхпхмю он йбк, л..........................  .',$)
      READ(*,*,ERR=12004) BK
12005 WRITE(*,2005)
2005  FORMAT(/1X, 'бшянрю анпрю, л............................ ',$)
      READ(*,*,ERR=12005) H
12007 WRITE(*,2007)
2007  FORMAT(/1X, 'няюдйю нянаюъ, л. ..........................',$)
      READ(*,*,ERR=12007) TOC
22008 WRITE(*,1008)
1008  FORMAT(/1X, 'лнлемр хмепжхх оноепевмнцн яевемхъ ,л**4... ',$)
      READ(*,*,ERR=22008) GI
22007 WRITE(*,3007)
3007  FORMAT(/1X, 'окнрмнярэ бндш, р/л**3 . ...................',$)
      READ(*,*,ERR=22007) GAM
2016  WRITE(*,1302)
